...
const needles=[/audio_assets/i,/music/i,/license_status/i,/\/api\/audio/i,/chooseMusic/i,/production_items/i,/\/api\/production/i,/retry/i,/status='done'/i];
const ranges=[];
