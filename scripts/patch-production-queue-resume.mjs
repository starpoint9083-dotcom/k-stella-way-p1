...
console.log('PRODUCTION QUEUE RESUME PATCH OK: production resume restores only unlinked cancelled/stale-generating missing-scene queues to waiting so zero-cost asset reuse can run before rendering.');
